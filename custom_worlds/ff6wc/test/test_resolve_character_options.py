...
from custom_worlds.ff6wc.Options import StartingCharacter1, StartingCharacter2, StartingCharacter3, resolve_character_options
from custom_worlds.ff6wc import Rom
