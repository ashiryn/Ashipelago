...
from custom_worlds.tloz_oos.patching.text import normalize_text
from custom_worlds.tloz_oos.patching.text.decoding import parse_dict_seasons, parse_all_texts
