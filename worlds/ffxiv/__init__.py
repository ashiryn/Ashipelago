...
def hide_nmw() -> bool:
    ...
    if "Build APWorlds" in sys.argv:
        return True
    if "Build Custom APWorlds" in sys.argv:
        return True
    return False
...
class NonManualWorld(ManualWorld):
    """Final Fantasy XIV
            (FFXIV) is a critically acclaimed MMORPG developed by Square Enix, widely praised for its immersive, story-driven gameplay, featuring a massive, ongoing narrative.
            It boasts an award-winning experience, particularly with its Heavensward and Shadowbringers expansions.
            The game is known for a welcoming community and an extensive, unrestricted free trial. """
